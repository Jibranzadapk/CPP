//calling constructors of the parent when contructor of that 
//sign is not availabale in child
...
class DistSign : public Distance //adds sign to Distance
{
	...
	DistSign(int ft, float in, posneg sg) : Distance(ft, in) //call base constructor
