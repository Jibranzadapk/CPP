...
class Distance //English Distance class
{
	...
	{
		if(in >= 12.0)
		throw InchesEx("invalid value for inches", in);
	
		if(ft >= 100.0)
		throw InchesEx("invalid value for feet", in);
	...
	void getdist() //get length from user
	{
		...
		if(feet >= 100.0)
		throw InchesEx("invalid value for feet", feet);
...
int main()
{
	...
	{
		cout << "\nInitialization error because of " << ix.origin
